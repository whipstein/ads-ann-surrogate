...
FIT_SHARED_OPTION_KEYS = {
    ...
    "output_scaler_floor",
    "parameter_names",
    "passivity_collocation_candidate_multiplier",
    "passivity_collocation_frequencies",
    "passivity_collocation_geometries",
    "passivity_collocation_geometry_json",
    "passivity_collocation_refresh",
    "passivity_margin",
    "passivity_mode",
    "passivity_penalty",
    "patience",
        ...
        "models": {
            ...
            "dnn": {
                "commands": {
                    "fit": {
                        "output_domain": "s",
                        "passivity_collocation_candidate_multiplier": 4,
                        "passivity_collocation_frequencies": 32,
                        "passivity_collocation_geometries": 0,
                        "passivity_collocation_geometry_json": None,
                        "passivity_collocation_refresh": 25,
            ...
            "points": {
                "commands": {
                    ...
                    "suggest-additional": {
                        ...
                        "out": None,
                        "parameter_json": None,
                        "previous_verification_metrics": None,
                        "rational_components": 8,
                        "rational_frequency_weights": None,
                        "rational_order": 12,
                        "rational_pole_damping": 0.18,
