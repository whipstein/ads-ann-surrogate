...
and written under `worst_case_y_plots/`, which shows the admittance response
that a direct circuit implementation would stamp. Use `--worst-plots 0` to
skip both plot sets during large experiments.
